...
func registerGuru(api fiber.Router, ctx *controllers.AppContext) {
	...
	l.Get("/subjects/:subjectId/teaching-module/suggestions", middlewares.RoleAllowed("GURU"), ctx.GetTeachingModuleSuggestions)
	l.Post("/subjects/:subjectId/teaching-module/generate-ai", middlewares.RoleAllowed("GURU"), ctx.GenerateTeachingModuleWithAI)
	l.Get("/subjects/:subjectId/teaching-modules", middlewares.RoleAllowed("GURU"), ctx.GetTeachingModuleDraftList)
	l.Post("/subjects/:subjectId/teaching-modules", middlewares.RoleAllowed("GURU"), ctx.SaveTeachingModuleDraft)
	l.Put("/subjects/:subjectId/teaching-modules/:moduleId", middlewares.RoleAllowed("GURU"), ctx.UpdateTeachingModuleDraft)
	l.Delete("/subjects/:subjectId/teaching-modules/:moduleId", middlewares.RoleAllowed("GURU"), ctx.DeleteTeachingModuleDraft)
