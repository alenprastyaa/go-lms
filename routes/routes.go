...
func registerClass(api fiber.Router, ctx *controllers.AppContext) {
	...
	r.Get("/levels", middlewares.RoleAllowed("ADMIN"), ctx.GetClassLevels)
	r.Post("/levels", middlewares.RoleAllowed("ADMIN"), ctx.CreateClassLevel)
	r.Put("/levels/:id", middlewares.RoleAllowed("ADMIN"), ctx.UpdateClassLevel)
	r.Delete("/levels/:id", middlewares.RoleAllowed("ADMIN"), ctx.DeleteClassLevel)
	r.Post("/bulk-generate", middlewares.RoleAllowed("ADMIN"), ctx.BulkGenerateClasses)
...
func registerGuru(api fiber.Router, ctx *controllers.AppContext) {
	...
	l.Get("/subjects/:subjectId/teaching-module/suggestions", middlewares.RoleAllowed("GURU"), middlewares.ModuleAllowed(ctx.DB, "teaching_module_ai"), ctx.GetTeachingModuleSuggestions)
	l.Post("/subjects/:subjectId/teaching-module/generate-ai", middlewares.RoleAllowed("GURU"), middlewares.ModuleAllowed(ctx.DB, "teaching_module_ai"), ctx.GenerateTeachingModuleWithAI)
	l.Get("/subjects/:subjectId/teaching-modules", middlewares.RoleAllowed("GURU"), middlewares.ModuleAllowed(ctx.DB, "teaching_module_ai"), ctx.GetTeachingModuleDraftList)
	l.Post("/subjects/:subjectId/teaching-modules", middlewares.RoleAllowed("GURU"), middlewares.ModuleAllowed(ctx.DB, "teaching_module_ai"), ctx.SaveTeachingModuleDraft)
	l.Put("/subjects/:subjectId/teaching-modules/:moduleId", middlewares.RoleAllowed("GURU"), middlewares.ModuleAllowed(ctx.DB, "teaching_module_ai"), ctx.UpdateTeachingModuleDraft)
	l.Delete("/subjects/:subjectId/teaching-modules/:moduleId", middlewares.RoleAllowed("GURU"), middlewares.ModuleAllowed(ctx.DB, "teaching_module_ai"), ctx.DeleteTeachingModuleDraft)
	...
	l.Post("/question-bank/upload-image", middlewares.RoleAllowed("GURU"), ctx.UploadLearningQuestionBankImage)
	...
	l.Get("/subjects/:subjectId/question-bank/topic-suggestions", middlewares.RoleAllowed("GURU"), ctx.GetLearningQuestionBankTopicSuggestions)
